TASK: lets create an emacs function to iterate over each function in this file and call describe function on it.
HINT:here is some code that might help you.
...
TASK again:lets create a function to iterate over each function in this file and call describe function on it.
