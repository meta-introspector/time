...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-s2vafi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-s2vafi.containers.anotherwebservice.com/
...
```
git clone git@github.com:meta-introspector/time.git
cd container-s2vafi
```
...
```
docker attach container-s2vafi
```
